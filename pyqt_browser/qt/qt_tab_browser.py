...
class Ui_botBrowserTabWidget_2(object):
    def setupUi(self, botBrowserTabWidget_2):
        ...
        self.gridLayout = QtGui.QGridLayout(botBrowserTabWidget_2)
        self.gridLayout.setObjectName("gridLayout")
        self.botBrowserTabWidget = QtGui.QTabWidget(botBrowserTabWidget_2)
        ...
        self.widget.setMinimumSize(QtCore.QSize(220, 16777215))
        ...
        self.listWidget_2 = QtGui.QListWidget(self.layoutWidget_2)
        self.listWidget_2.setObjectName("listWidget_2")
        self.verticalLayout.addWidget(self.listWidget_2)
        self.gridLayout_2.addWidget(self.splitter, 0, 0, 1, 1)
        # self.explorer_widget = QtGui.QWidget(self.splitter_2)
        ...
        self.adv_explorer_widget = QtGui.QWidget(self.tab_2)
        ...
        QtCore.QMetaObject.connectSlotsByName(botBrowserTabWidget_2)

    def retranslateUi(self, botBrowserTabWidget_2):
        botBrowserTabWidget_2.setWindowTitle(QtGui.QApplication.translate("botBrowserTabWidget_2", "Form", None, QtGui.QApplication.UnicodeUTF8))
        self.label.setText(QtGui.QApplication.translate("botBrowserTabWidget_2", "My Task:", None, QtGui.QApplication.UnicodeUTF8))
        self.label_2.setText(QtGui.QApplication.translate("botBrowserTabWidget_2", "Quick Access:", None, QtGui.QApplication.UnicodeUTF8))
        self.botBrowserTabWidget.setTabText(self.botBrowserTabWidget.indexOf(self.tab), QtGui.QApplication.translate("botBrowserTabWidget_2", "Explorer", None, QtGui.QApplication.UnicodeUTF8))
        self.botBrowserTabWidget.setTabText(self.botBrowserTabWidget.indexOf(self.tab_2), QtGui.QApplication.translate("botBrowserTabWidget_2", "Show View", None, QtGui.QApplication.UnicodeUTF8))
