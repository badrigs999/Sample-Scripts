...
class Content_Treeview_Widget(QWidget):
    ...
    def __init__(self,parent=None):
        ...
        #self.viewPreviewSplitter.setSizePolicy(sizePolicy)
        
        self.viewPreviewSplitter.addWidget(self.view)

        self.viewPreviewSplitter.addWidget(self.preview)
    ...
    def splitter_move_action(self, pos, index):
        ...
        pass
        # if self.viewPreviewSplitter.sizes()[1]:
        #     pass
        # else:

        # if pos==self.height()-5:
        #     print "enable"
        # else:
        #     print "disable"
        # print self.viewPreviewSplitter.isVisible()
    ...
    def setup_context_menu(self):
        ...
        self.viewPreviewSplitter.setSizes([390, 0])
        self.viewPreviewSplitter.setFocus()
