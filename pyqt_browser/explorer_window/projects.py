...
#_____________Start___________________________
# Updated By Badri (09-12-2020)
# (?# sys.path.insert(0, r"\\botcentral\BotScripts\Software\staging"))
# from get_show_list import fetch_all_shows
#_____________End___________________________
...
class Project_Item():
    ...
    def __init__(self, properties, parent=None):
        ...
        #----------------Start---------------------------
        # Get Botcentral Show Data
        # show_list = fetch_all_shows()
        show_list = []
        #----------------End---------------------------
